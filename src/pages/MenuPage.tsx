        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="text-2xl font-serif font-bold mb-2">Special Requests?</h3>
              <p className="text-cafe-100">
                We can customize dishes to your preference or dietary needs.
              </p>
            </div>
            <Button asChild className="bg-white text-cafe-800 hover:bg-cafe-100">
              <a href="tel:+9779800000000">Call Us: +977 980-000-0000</a>
            </Button>
          </div>
        </div>
      </section>
